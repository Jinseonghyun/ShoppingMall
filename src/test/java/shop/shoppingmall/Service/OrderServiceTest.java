...
import shop.shoppingmall.domain.OrdersStatus;
...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        assertEquals("상품 주문시 상태는 ORDER", OrdersStatus.ORDER, getOrder.getStatus());
    ...
    public void 주문취소() throws Exception {
        ...
        assertEquals("주문 취소시 상태는 CANCEL 이다.", OrdersStatus.CANCEL, getOrder.getStatus());
